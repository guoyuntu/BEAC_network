...
np.savetxt("../../result/unsp_bi_em/train/val_position.txt",position_test,fmt="%d")
...
out_theta = []
out_position = []
ff = open('../../result/unsp_bi_em/train/accuracy.txt','w+')
...
for epoch_i in range(n_epochs):
    ...
    if epoch_i % 1 == 0:
        ...
        np.savetxt("../../result/unsp_bi_em/train_theta_result_"+str(epoch_i)+".txt",out_theta,fmt="%f")
        ...
        np.savetxt("../../result/unsp_bi_em/val_theta_result_"+str(epoch_i)+".txt",val_theta,fmt="%f")

        saver.save(sess, '../../model/unsp_bi_em/' + str(epoch_i) + '.tfmodel');
