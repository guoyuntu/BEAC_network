...
out_theta = []
out_position = []
ff = open('/home/g_jiarui/video_spacial_tu/result/3/train/accuracy.txt','w+')

#saver.restore(sess, '/home/g_jiarui/video_spacial_tu/result/3/Ekman6.tfmodel')
...
for epoch_i in range(n_epochs):
    ...
    if epoch_i % 5 == 0:
    	...
    	np.savetxt("/home/g_jiarui/video_spacial_tu/result/3/train_theta_result_"+str(epoch_i)+".txt",out_theta,fmt="%f")

    	val_theta = sess.run(h_fc_loc2, feed_dict={x: X_valid, y: Y_valid, keep_prob: 1.0})
        np.savetxt("/home/g_jiarui/video_spacial_tu/result/3/val_theta_result_"+str(epoch_i)+".txt",val_theta,fmt="%f")
        
        saver.save(sess, '/home/g_jiarui/video_spacial_tu/result/3/Ekman6.tfmodel')
